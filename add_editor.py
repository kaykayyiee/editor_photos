...
win.show()
workdir = ''
def chooseWorkdir():#membuka dialog pemilihan folder, yang memungkinkan pengguna memilih direktori kerja, 
   global workdir
   workdir = QFileDialog.getExistingDirectory()#membuka dialog pemilihan folder dan menyimpan pathnya ke dalam workdir

def filter(files, extensions):#memfilter daftar file berdasarkan ekstensi yang ditentukan
   result = []
...
class ImageProcessor():
    ...
    def saveImage(self):
        "save a copy of the file in a sub-folder"
